...
class AuthorizationVC: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    slides = [OnboardingSlide(title: "Say goodbye to missing warranties", description: "eWarranty help you to save all your warranties", image: UIImage(named: "imageOne")! ),
